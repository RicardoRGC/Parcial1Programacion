...
class Heladeria
{
    ...
    //--------------------------------------------------------------------------------------------------
    public static function DescontarStock($producto, $array)
    {
        ...
        if (Heladeria::Equals($array, $producto)) {
            ...
            foreach ($array as $value) {
                ...
                if (
                    ...
                    if ($producto->Getstock() <= $value->Getstock()) {

                        echo "<br/>  stock " . $value->Getstock() . " ";
                        echo "<br/>  se descuenta al stock :" . $producto->Getstock() . " ";

                        $value->SetstockDescontar($producto->Getstock());

                        echo "<br/> stock Total " . $value->Getstock() . " <br/>";
                        echo "<br/>  producto modificado ";
    ...
    public static function AgregarProductoEnArray($array, $producto)
    {
        $arrayAux = $array;
